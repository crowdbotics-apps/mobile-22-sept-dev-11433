...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_HYTUYT_LIST:
    case types.API_V1_HYTUYT_LIST_SUCCEEDED:
    case types.API_V1_HYTUYT_LIST_FAILED:
    case types.API_V1_HYTUYT_CREATE:
    case types.API_V1_HYTUYT_CREATE_SUCCEEDED:
    case types.API_V1_HYTUYT_CREATE_FAILED:
    case types.API_V1_HYTUYT_READ:
    case types.API_V1_HYTUYT_READ_SUCCEEDED:
    case types.API_V1_HYTUYT_READ_FAILED:
    case types.API_V1_HYTUYT_UPDATE:
    case types.API_V1_HYTUYT_UPDATE_SUCCEEDED:
    case types.API_V1_HYTUYT_UPDATE_FAILED:
    case types.API_V1_HYTUYT_PARTIAL_UPDATE:
    case types.API_V1_HYTUYT_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_HYTUYT_PARTIAL_UPDATE_FAILED:
    case types.API_V1_HYTUYT_DELETE:
    case types.API_V1_HYTUYT_DELETE_SUCCEEDED:
    case types.API_V1_HYTUYT_DELETE_FAILED:
